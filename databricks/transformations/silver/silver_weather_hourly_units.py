...
def compute_silver_weather_hourly_units(df):
    """Select the unit fields from the 'hourly_units' object of raw bronze weather rows.
...
def silver_weather_hourly_units():
    return compute_silver_weather_hourly_units(
